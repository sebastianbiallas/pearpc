...
enum X86BitSearch {
	...
	void asmALU32(X86ALUopc opc, const void *mem, NativeReg reg);
	void asmALU32(X86ALUopc opc, NativeReg reg, const void *mem);
...
void asmALUPS(X86ALUPSopc opc, NativeVectorReg reg1, NativeReg base, uint32 disp);

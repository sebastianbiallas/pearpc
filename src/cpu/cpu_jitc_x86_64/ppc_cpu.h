...
//#define RSP_OFFSET (sizeof (PPC_CPU_State) + 0)
#define RSP_OFFSET (8)

#define curCPU(field) RSP, uint32(RSP_OFFSET + offsetof(PPC_CPU_State, field))
#define curCPUreg(ofs) RSP, uint32(RSP_OFFSET + uint32(ofs))
#define curCPUsib(field, scale, index) RSP, scale, index, uint32(RSP_OFFSET + offsetof(PPC_CPU_State, field))

enum PPC_Register {
	PPC_REG_NO = 0,
	PPC_GPR0 = offsetof(PPC_CPU_State, gpr),
	PPC_FPR0 = offsetof(PPC_CPU_State, fpr),
...
extern "C" void ppc_cpu_atomic_raise_dec_exception(PPC_CPU_State &aCPU);
extern "C" void ppc_cpu_atomic_raise_ext_exception(PPC_CPU_State &aCPU);
extern "C" void ppc_cpu_atomic_raise_stop_exception(PPC_CPU_State &aCPU);
extern "C" void ppc_cpu_atomic_cancel_ext_exception(PPC_CPU_State &aCPU);

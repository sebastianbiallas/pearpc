...
A64Instr a64_AND_imm(int rd, int rn, int N, int immr, int imms); // AND Xd, Xn, #bitmask
A64Instr a64_ORR_imm(int rd, int rn, int N, int immr, int imms); // ORR Xd, Xn, #bitmask

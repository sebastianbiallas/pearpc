...
#endif
    static bool msrTraced = false;
    if ((newmsr & PPC_CPU_UNSUPPORTED_MSR_BITS) && !msrTraced) {
        msrTraced = true;
        fprintf(stderr, "[MSR-FIRST] unsupported=%08x new=%08x old=%08x pc=%08x srr0=%08x srr1=%08x\n",

 ...
 *  jitc_common.h
 *
 *  AArch64 CPU state offset definitions for assembly code
 *
...
/*
 * On AArch64, X20 holds the pointer to PPC_CPU_State (curCPU).
 * X19 holds the pointer to JITC.
 *
 * curCPU(r) expands to [x20, #r] for use in LDR/STR instructions.
 */
#define curCPU(r) x20, #r

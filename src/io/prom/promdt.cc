...
/*	//
	...
	PHANDLE(pic),       0x00,0x00,0x00,0x1a,
	// macio
	...
	byte reg4[] = {
	//   bus   dev
	0x00,0x01,0x28,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00, 0x02,0x01,0x28,0x10, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
...
//	eth0->addProp(new PromPropString("driver,AAPL,MacOSX,PowerPC", ""));
	...
	byte eth0aa[] = {
	0x81,0x01,0x60,0x10, 0x00,0x00,0x00,0x00, 0x00,0x00,0x10,0x00, 0x00,0x00,0x00,0x00,
	0x00,0x00,0x01,0x00,
	};
	...
	0x00,0x00,0x00,0x00,
	0x02,0x01,0x30,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x10,0x00};
	usb->addProp(new PromPropMemory("reg", &usbreg, sizeof usbreg));
	byte usbaa[] = {
	0x82,0x01,0x30,0x10,0x00,0x00,0x00,0x00,0x80,0x88,0x10,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x10,0x00};
